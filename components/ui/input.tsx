    ...
    return (
      <div className="relative w-full">
        ...
        <input
          type={type}
          className={cn(
            "flex h-11 w-full rounded-[10px] border border-[#27272a] bg-[#141416] px-3.5 py-2 text-sm text-neutral-100 placeholder:text-neutral-500 focus:outline-none focus:border-[var(--input-focus-border)] focus:ring-2 focus:ring-[var(--input-focus-ring)] disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200",
