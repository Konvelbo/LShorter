...
export default function PlasmaWave({
  ...
  useEffect(() => {
    ...
    const c1 = hexToRgb(colors[0] || "#FF5B00");
    const c2 = hexToRgb(colors[1] || "#0080ff");
    ...
    const update = (now: number) => {
      ...
      uniformOffset[0] = p.xOffset;
      uniformOffset[1] = p.yOffset;
      ...
      program.uniforms.uColor1.value = hexToRgb(p.colors[0] || "#FF5B00");
      program.uniforms.uColor2.value = hexToRgb(p.colors[1] || "#0080ff");
